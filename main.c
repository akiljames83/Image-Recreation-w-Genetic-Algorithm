...
int main(void) {
  ...
  int population_size = 500; // greater than 10 is seg fault ??
  int num_generations = 10000;//minute*60; // 4000 iterations per minute
  double rate = 3e-2;
  ...
  write_ppm("ned_demo_mcmaster.ppm",new_image);
  free_image(image);
